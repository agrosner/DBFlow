...
public class WhereQueryBuilder<ModelClass extends Model> extends QueryBuilder<WhereQueryBuilder<ModelClass>> {
    ...
    /**
     * Appends a param to this map. It will take the value and see if a {@link com.raizlabs.android.dbflow.converter.TypeConverter}
    ...
    protected String convertValueToString(String columnName, Object value) {
        ...
        if (value instanceof Number) {
            ...
            stringVal = DatabaseUtils.sqlEscapeString(String.valueOf(value));
        }
