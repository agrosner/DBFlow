...
import com.raizlabs.android.dbflow.sql.DefaultModel
import com.raizlabs.android.dbflow.sql.DefaultModel_Table
        ...
        val query = SQLite.select()
                ...
                .innerJoin(
                        SQLite.select(DefaultModel_Table.count,
                                ...
                                .from(com.raizlabs.android.dbflow.sql.DefaultModel::class.java)
