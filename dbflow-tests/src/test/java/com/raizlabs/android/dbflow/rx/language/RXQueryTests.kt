...
class RXQueryTests : BaseUnitTest() {
    ...
    @Test
    fun testCanQuery() = writableDatabaseForTable<SimpleModel> {
    ...
    @Test
    fun testCanCompileStatement() = writableDatabaseForTable<SimpleModel> {
    ...
    @Test
    fun testCountMethod()  = writableDatabaseForTable<SimpleModel>{
        SimpleModel("name").save()
    ...
    @Test
    fun testInsertMethod() = writableDatabaseForTable<SimpleModel> {
        var count = 0L
