...
class InsertTest : BaseUnitTest() {
    ...
    @Test
    fun validateInsert() = writableDatabaseForTable<SimpleModel>{
        assertEquals("INSERT INTO `SimpleModel` VALUES('something')",
                insert<SimpleModel>().values("something").query.trim())
    }

    @Test
    fun validateInsertOr() = writableDatabaseForTable<SimpleModel> {
    ...
    @Test
    fun validateInsertProjection()= writableDatabaseForTable<SimpleModel> {
    ...
    @Test
    fun validateSelect()= writableDatabaseForTable<SimpleModel> {
    ...
    @Test
    fun validateColumns()= writableDatabaseForTable<SimpleModel> {
        assertEquals("INSERT INTO `TwoColumnModel`(`name`, `id`) VALUES('name', 'id')",
    ...
    @Test
    fun validateColumnValues()= writableDatabaseForTable<SimpleModel> {
