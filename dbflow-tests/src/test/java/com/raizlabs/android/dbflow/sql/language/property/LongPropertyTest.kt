...
class LongPropertyTest : BaseUnitTest() {

    @Test
    fun testOperators() {
        val prop = LongProperty(SimpleModel::class.java, "Prop")
    ...
    @Test
    fun testAlias() {
        val prop = LongProperty(SimpleModel::class.java, "Prop", "Alias")
        assertEquals("`Prop` AS `Alias`", prop.toString().trim())

        val prop2 = LongProperty(SimpleModel::class.java,
