 ...
 */
@com.raizlabs.android.dbflow.annotation.TypeConverter(allowedSubtypes = arrayOf(GregorianCalendar::class))
 ...
 */
@com.raizlabs.android.dbflow.annotation.TypeConverter(allowedSubtypes = arrayOf(Time::class, Timestamp::class))
