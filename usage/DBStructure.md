...
4. All fields must be `public` or package private as the `$Adapter` class needs access to them. Package private fields need not be in the same package as DBFlow will generate the neccessary access methods to get to them.
