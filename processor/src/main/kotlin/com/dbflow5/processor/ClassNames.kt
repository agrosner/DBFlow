...
object ClassNames {
    ...
    val CONTENT_PROVIDER_DATABASE = ClassName.get(PROVIDER, "ContentProviderDatabase")
    ...
    val SIMPLE_MAP_CACHE = ClassName.get("$QUERY_PACKAGE.cache", "SimpleMapCache")
    ...
    val NON_NULL_X = ClassName.get("androidx.annotation", "NonNull")
