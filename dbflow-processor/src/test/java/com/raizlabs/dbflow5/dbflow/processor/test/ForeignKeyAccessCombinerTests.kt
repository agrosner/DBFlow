package com.raizlabs.dbflow5.dbflow.processor.test

import com.raizlabs.dbflow5.dbflow.processor.definition.column.*
import com.raizlabs.dbflow5.dbflow.processor.definition.column.PrimaryReferenceAccessCombiner
...
class ForeignKeyAccessCombinerTest {
    ...
    fun test_canLoadFromCursor() {
        val foreignKeyAccessCombiner = ForeignKeyLoadFromCursorCombiner(VisibleScopeColumnAccessor("testModel1"),
                ClassName.get("com.raizlabs.dbflow5.dbflow.test.container", "ParentModel"),
                ClassName.get("com.raizlabs.dbflow5.dbflow.test.container", "ParentModel_Table"), false,
                NameAllocator())
    ...
    fun test_canLoadFromCursorStubbed() {
        val foreignKeyAccessCombiner = ForeignKeyLoadFromCursorCombiner(VisibleScopeColumnAccessor("testModel1"),
                ClassName.get("com.raizlabs.dbflow5.dbflow.test.container", "ParentModel"),
                ClassName.get("com.raizlabs.dbflow5.dbflow.test.container", "ParentModel_Table"), true,
                NameAllocator())
        foreignKeyAccessCombiner.fieldAccesses += PartialLoadFromCursorAccessCombiner("testmodel_id",
