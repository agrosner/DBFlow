...
import com.raizlabs.dbflow5.dbflow.annotation.TypeConverter
...
class TypeConverterHandler : BaseContainerHandler<TypeConverter>() {
    ...
    override fun onProcessElement(processorManager: ProcessorManager, element: Element) {
        if (element is TypeElement) {
            val className = com.raizlabs.dbflow5.dbflow.processor.utils.fromTypeMirror(element.asType(), processorManager)
