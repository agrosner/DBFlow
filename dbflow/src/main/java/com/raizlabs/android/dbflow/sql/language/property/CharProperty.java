...
public class CharProperty extends BaseProperty<CharProperty> {
    ...
    public CharProperty(Class<? extends Model> table, NameAlias2 nameAlias) {
    ...
    public CharProperty plus(IProperty iProperty) {
        return new CharProperty(table, NameAlias2.joinNames(Condition.Operation.PLUS,
                nameAlias.fullName(), iProperty.toString()));
    }

    @Override
    public CharProperty minus(IProperty iProperty) {
        return new CharProperty(table, NameAlias2.joinNames(Condition.Operation.MINUS,
                nameAlias.fullName(), iProperty.toString()));
    }

    @Override
    public CharProperty dividedBy(IProperty iProperty) {
        return new CharProperty(table, NameAlias2.joinNames(Condition.Operation.DIVISION,
                nameAlias.fullName(), iProperty.toString()));
    }

    @Override
    public CharProperty multipliedBy(IProperty iProperty) {
        return new CharProperty(table, NameAlias2.joinNames(Condition.Operation.MULTIPLY,
                nameAlias.fullName(), iProperty.toString()));
    }

    @Override
    public CharProperty mod(IProperty iProperty) {
        return new CharProperty(table, NameAlias2.joinNames(Condition.Operation.MOD,
                nameAlias.fullName(), iProperty.toString()));
    }

    @Override
    public CharProperty concatenate(IProperty iProperty) {
        return new CharProperty(table, NameAlias2.joinNames(Condition.Operation.CONCATENATE,
                nameAlias.fullName(), iProperty.toString()));
    }
    ...
    @Override
    public CharProperty withTable(NameAlias2 tableNameAlias) {
        return new CharProperty(table, nameAlias
                .newBuilder()
