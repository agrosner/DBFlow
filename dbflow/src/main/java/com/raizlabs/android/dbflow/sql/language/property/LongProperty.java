...
public class LongProperty extends BaseProperty<LongProperty> {
    ...
    public LongProperty(Class<? extends Model> table, NameAlias2 nameAlias) {
    ...
    public LongProperty plus(IProperty iProperty) {
        return new LongProperty(table, NameAlias2.joinNames(Condition.Operation.PLUS,
                nameAlias.fullName(), iProperty.toString()));
    }

    @Override
    public LongProperty minus(IProperty iProperty) {
        return new LongProperty(table, NameAlias2.joinNames(Condition.Operation.MINUS,
                nameAlias.fullName(), iProperty.toString()));
    }

    @Override
    public LongProperty dividedBy(IProperty iProperty) {
        return new LongProperty(table, NameAlias2.joinNames(Condition.Operation.DIVISION,
                nameAlias.fullName(), iProperty.toString()));
    }
    ...
    public LongProperty mod(IProperty iProperty) {
        return new LongProperty(table, NameAlias2.joinNames(Condition.Operation.MOD,
                nameAlias.fullName(), iProperty.toString()));
    }

    @Override
    public LongProperty concatenate(IProperty iProperty) {
        return new LongProperty(table, NameAlias2.joinNames(Condition.Operation.CONCATENATE,
                nameAlias.fullName(), iProperty.toString()));
    }
    ...
    @Override
    public LongProperty withTable(NameAlias2 tableNameAlias) {
        return new LongProperty(table, nameAlias
                .newBuilder()
